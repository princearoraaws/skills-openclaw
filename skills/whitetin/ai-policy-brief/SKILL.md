...
description: 聚合国内最新AI相关政策，覆盖国家级（国务院、工信部、科技部、网信办等）和广东省及下辖市（广州、深圳、珠海、佛山等）的政策动态，提供简报式解读。
---

# AI政策简报

> 追踪国内最新AI相关政策动态，覆盖国家级与广东省及下辖市
...
- 东莞市人民政府（www.dg.gov.cn）
- 佛山市顺德区人民政府（www.shunde.gov.cn）

> 注：深圳市政府官网SSL握手在本地环境持续失败，已暂时移除深圳官网爬虫，深圳市政策可通过smartcity.team聚合源获取。
...
Phase 1: 信息收集（爬虫脚本）
  ...
  ├─ 并发爬取33个目标网站（国家级/广东省21地市/权威媒体6家）
  └─ 读取输出 JSON 结果
      ↓
Phase 2: 内容过滤
  ├─ 保留：最近30天内发布的政策
...
**广东省市（5个）**：广东省、广州、佛山、东莞、顺德区（仅保留需求指定地市，精简爬取范围提高速度；深圳市政府官网本地SSL连接失败，暂时移除，深圳市政策通过聚合源获取）

**补充聚合（1个）**：smartcity.team 人工智能政策聚合站，自动抓取全国各省市最新AI政策
...
在最近30天内，未查询到国务院、工信部、科技部、网信办及广东省、广州市、深圳市、佛山市/顺德区等机构的AI相关政策更新。
