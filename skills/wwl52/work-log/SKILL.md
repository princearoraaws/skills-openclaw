---
name: work-log
description: 自动化记录工作日志，每日/每周定时生成专业日报周报，支持表格和文本双模式输出
version: 1.2.0
icon: 📝
metadata:
  clawdbot:
...
日志存储在：`C:\Users\19625\.workbuddy\work-log\logs.json`
...
```
本周核心事项
1. 【分类】任务名称（MM-DD HH:MM）：进展/结果简述（附进度百分比）

分项详述（可扩展）
- 【运维维护】项目A（MM-DD HH:MM）：进度 XX% 关键进展：描述
  详细：具体说明、问题描述或解决方案
  下周计划：使用者填写

- 【开发任务】项目B（MM-DD HH:MM）：进度 XX% 关键进展：描述
  详细：具体说明、问题描述或解决方案
  下周计划：使用者填写
...
AI风险预测与工作建议（基于本周工作）
- 【运维维护】项目A（MM-DD HH:MM）
  风险预测：...
  工作建议：...
- 【开发任务】项目B（MM-DD HH:MM）
  风险预测：...
  工作建议：...
...
AI周度复盘/心得
- 【运维维护】项目A（MM-DD HH:MM）：收获/反思/改进点
- 【开发任务】项目B（MM-DD HH:MM）：收获/反思/改进点
```
