#!/usr/bin/env python3
"""
City of Edmonton Open Data — CLI for the Socrata SODA API.
No dependencies beyond stdlib. Accesses data.edmonton.ca.

Usage:
  python3 edmonton_data.py <command> [args]
...
def cmd_geojson(dataset_id, options):
    ...
    # Also check for location fields
    if not lat_col:
        for key in sample:
